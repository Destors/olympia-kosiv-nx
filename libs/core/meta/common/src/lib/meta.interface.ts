...
export const META_CONFIG_DEFAULT: MetaConfig = {
  title: `:Meta default|:Online store Banshop`,
  // eslint-disable-next-line max-len
  description: `:Meta default|:Banshop sportswear, shoes and accessories. Free delivery in Moscow and all over Russia when paying on the website.`,
  keywords: `:Meta default|:sneakers, sports shoes`,
};
