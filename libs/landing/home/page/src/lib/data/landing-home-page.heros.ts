...
export const HERO_SPORT_FOOD: HeroModel = {
  img: '../assets/landing/img/heroSportFood.JPG',
  title: 'Спортивне харчування',
  // eslint-disable-next-line max-len
  desc: 'Готуємо готові коктейлі прямо у залі. Також можна придбати будь яке спортивне харчування під замовлення або із наявності.',
};
